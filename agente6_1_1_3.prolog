...
verificaNo(X,Y,X1,Y1,H,CANT) :- 
    ...
    ;
        write(' - Lista não vazia - '), C1R is C1 + CANT, write(' | Custo Total: '), write(C1R), custoMinimo(CMIN),
        C1R > CMIN,
...
caminhar(X,Y,H) :- % sleep(1),
    ...
    */
        ...
        custoMinimo(CMIN), write('Custo mínimo: '), writeln(CMIN),
        (
            C > CMIN, writeln('-- Custo Inferior. --'), retract(custoMinimo(CMIN)), assert(custoMinimo(C)), assert(bicho(X,Y)), assert(mente((X,Y),alimento)),
        ...
        ;
        writeln(''), writeln(''), writeln('Melhor caminho: '), melhorCaminho(CP), writeln(CP), writeln(''), write('Custo: '), custoMinimo(CM), writeln(CM), writeln(''), writeln(''), !), ! %, 
...
exibeMelhorCaminho :- writeln(''), writeln(''), writeln('Melhor caminho: '), melhorCaminho(CP), writeln(CP), writeln(''), write('Custo: '), custoMinimo(CM), writeln(CM), writeln(''), writeln('').
